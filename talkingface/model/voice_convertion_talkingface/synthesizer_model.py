...
class Synthesizer(pl.LightningModule):
    ...
    def forward(self, text, mel_source, input_lengths, output_lengths, max_input_len):
        ...
        z_s_repeated = z_s_cota.unsqueeze(
        ...
        # [B, T_dec, chn.encoder]
        linguistic = torch.bmm(alignment, text_encoding)
    ...
    def training_step(self, batch, batch_idx):
        ...
        with torch.no_grad():
            ling_s, _ = self(text, mel_source, input_lengths,
        ...
        self.logger.log_loss(loss_rec, mode='train',
                             step=self.global_step, name='rec')
    ...
    def validation_step(self, batch, batch_idx):
        ...
        if self.is_val_first:
            ...
            self.logger.log_figures(
                mel_source, mel_s_s, mel_s_t, alignment, f0_padded, self.global_step)
